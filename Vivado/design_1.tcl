...
user.org:user:Sobel_AXI_Stream:1.0\
...
\
  ...
  # Create instance: Sobel_AXI_Stream_0, and set properties
  set Sobel_AXI_Stream_0 [ create_bd_cell -type ip -vlnv user.org:user:Sobel_AXI_Stream:1.0 Sobel_AXI_Stream_0 ]
  ...
  connect_bd_intf_net -intf_net Sobel_AXI_Stream_0_m_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins Sobel_AXI_Stream_0/m_axis]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins Sobel_AXI_Stream_0/s_axis]
  ...
  [get_bd_pins Sobel_AXI_Stream_0/axis_clk] \
  ...
  [get_bd_pins Sobel_AXI_Stream_0/axis_aresetn] \
